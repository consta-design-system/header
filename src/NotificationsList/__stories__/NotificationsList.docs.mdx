...
Список уведомлений с бейджиками, информацией о пользователе и группировкой. Содержимое для компонента [Notifications](?path=/docs/components-notifications--playground).
