...
> Блок с логином можно собрать из компонентов [Button](http://uikit.gizeasy.ru/?path=/docs/components-button--playground) и [User](http://uikit.gizeasy.ru/?path=/docs/components-user--playground)
