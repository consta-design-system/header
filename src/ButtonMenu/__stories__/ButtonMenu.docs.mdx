...
| `form?`          | `'default', 'round', 'brick', 'brickRound', 'roundBrick', 'brickDefault', 'defaultBrick'` | `'default'`             | Форма (см. [Button](http://uikit.consta.design/?path=/docs/components-button--playground))         |
| `size?`          | `'xs', 's', 'm', 'l'`                                                                     | `'m'`                   | Размер (см. [Button](http://uikit.consta.design/?path=/docs/components-button--playground))        |
| `view?`          | `'clear', 'primary', 'secondary', 'ghost'`                                                | `'primary'`             | Вид (см. [Button](http://uikit.consta.design/?path=/docs/components-button--playground))           |
| `onlyIcon?`      | `boolean`                                                                                 | -                       | Только иконка (см. [Button](http://uikit.consta.design/?path=/docs/components-button--playground)) |
