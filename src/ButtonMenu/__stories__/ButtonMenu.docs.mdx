...
export const ButtonMenuExample = () => <ButtonMenu items={menu} getItemLabel={item => item.name} />
```
...
| `onlyIcon?`      | `boolean`                                                                                 | -                       | Только иконка (см. [Button](https://consta-uikit.vercel.app/?path=/docs/components-button--playground)) |
