...
| `form?`          | `'default', 'round', 'brick', 'brickRound', 'roundBrick', 'brickDefault', 'defaultBrick'` | `'default'`             | Форма (см. [Button](##LIBS.STAND/stand:uikit-components-button-stable))         |
| `size?`          | `'xs', 's', 'm', 'l'`                                                                     | `'m'`                   | Размер (см. [Button](##LIBS.STAND/stand:uikit-components-button-stable))        |
| `view?`          | `'clear', 'primary', 'secondary', 'ghost'`                                                | `'primary'`             | Вид (см. [Button](##LIBS.STAND/stand:uikit-components-button-stable))           |
| `onlyIcon?`      | `boolean`                                                                                 | -                       | Только иконка (см. [Button](##LIBS.STAND/stand:uikit-components-button-stable)) |
