...
import { LanguagesDefaultItem } from '##/components/Languages';
import {
  MenuDefaultItem,
...
export type HeaderDefaultSocialMediaItem = ButtonMenuDefaultItem & {
  icon: IconComponent;
};
...
> = PropsWithHTMLAttributesAndRef<
  {
    ...
    notificationsGroups?: NOTIFICATION_GROUP_BY_DAY extends true
      ? never
      : NOTIFICATION_GROUP[];
