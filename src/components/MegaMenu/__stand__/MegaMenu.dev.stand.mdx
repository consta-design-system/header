...
```tsx
<MegaMenu items={items} view="vertical" position="fixed" />
<MegaMenu items={items} view="horizontal" position="fixed" />
```
...
| ----------------------- | --------------------------------- | ----------------------------- | ----------------------------------------------------------------------- |
| `position?`             | `'absolute', 'fixed'`             | `'absolute'`                  | Позиционирование компонента меню                                        |
