...
| `onGroupClick?`      | `GlobalMenuPropOnGroupClick`      | -                          | Событие по нажатию на группу меню                                       |
...
| `getItemGroupId?`    | `GlobalMenuPropGetItemGroupId`    | `defaultGetItemGroupId`    | Функция для определения идентификатора группы                           |
| `getItemAs?`         | `GlobalMenuPropGetItemAs`         | `defaultGetItemAs`         | Функция для определения тега элемента меню                              |
...
| `getGroupOnClick?`   | `GlobalMenuPropGetGroupOnClick`   | `defaultGetGroupOnClick`   | Функция для определения события по нажатию на группу меню               |
